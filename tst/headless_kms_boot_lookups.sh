...
kms_boot IMWAY_FAKE_KMS_FAIL_LOOKUPS=prop:EDID::-1 --
boot_rc 0 "EDID property undescribed"
...
# the second crtc's plane is listed first: the desktop pipe skips it
kms_boot IMWAY_FAKE_KMS_FAIL_LOOKUPS=plane:304::-1 --
boot_rc 0 "a plane undescribed"
