...
for mode in bad-source half-unset-width half-unset-height bad-dest out-of-buffer rotated-out-of-buffer fractional-height no-content cached-size cached-source cached-scale; do
