...
namespace {
    ...
    struct LibinputSource: public InputSource {
        ...
        void pointerMotion(libinput_event* ev);
        void pointerMotionAbsolute(libinput_event* ev);
        void swipeUpdate(libinput_event* ev);
        void pinchUpdate(libinput_event* ev);
        void tabletToolProximity(libinput_event* ev);
        void tabletToolTip(libinput_event* ev);
        void tabletToolAxis(libinput_event* ev);
        void tabletToolButton(libinput_event* ev);
        void deviceAdded(libinput_event* ev);
        void deviceRemoved(libinput_event* ev);
        void pointerButton(libinput_event* ev);
        void pointerScroll(libinput_event* ev);
        void keyboardKey(libinput_event* ev);
    };
...
void LibinputSource::pointerMotion(libinput_event* ev) {
...
void LibinputSource::pointerMotionAbsolute(libinput_event* ev) {
    auto* p = libinput_event_get_pointer_event(ev);
    PointerMotionEvent motion;
...
void LibinputSource::swipeUpdate(libinput_event* ev) {
...
void LibinputSource::pinchUpdate(libinput_event* ev) {
    auto* g = libinput_event_get_gesture_event(ev);
...
void LibinputSource::tabletToolProximity(libinput_event* ev) {
...
void LibinputSource::tabletToolTip(libinput_event* ev) {
    auto* t = libinput_event_get_tablet_tool_event(ev);
    TabletToolEvent tev;
...
void LibinputSource::tabletToolAxis(libinput_event* ev) {
    auto* t = libinput_event_get_tablet_tool_event(ev);
    TabletToolEvent tev;
...
void LibinputSource::tabletToolButton(libinput_event* ev) {
    auto* t = libinput_event_get_tablet_tool_event(ev);
    TabletToolEvent tev;
...
void LibinputSource::deviceAdded(libinput_event* ev) {
...
void LibinputSource::deviceRemoved(libinput_event* ev) {
...
void LibinputSource::pointerButton(libinput_event* ev) {
    auto* p = libinput_event_get_pointer_event(ev);
...
void LibinputSource::pointerScroll(libinput_event* ev) {
    auto* p = libinput_event_get_pointer_event(ev);
...
void LibinputSource::keyboardKey(libinput_event* ev) {
...
void LibinputSource::handleEvent(libinput_event* ev) {
    switch (libinput_event_get_type(ev)) {
        ...
        case LIBINPUT_EVENT_TABLET_TOOL_PROXIMITY:
            return tabletToolProximity(ev);
        case LIBINPUT_EVENT_TABLET_TOOL_TIP:
            return tabletToolTip(ev);
        case LIBINPUT_EVENT_TABLET_TOOL_AXIS:
            return tabletToolAxis(ev);
        case LIBINPUT_EVENT_TABLET_TOOL_BUTTON:
            return tabletToolButton(ev);
        case LIBINPUT_EVENT_GESTURE_HOLD_END:
            comp->entry->holdEnd(libinput_event_gesture_get_cancelled(libinput_event_get_gesture_event(ev)) != 0);
            return;
        case LIBINPUT_EVENT_DEVICE_ADDED:
            return deviceAdded(ev);
        case LIBINPUT_EVENT_DEVICE_REMOVED:
            return deviceRemoved(ev);
        case LIBINPUT_EVENT_POINTER_BUTTON:
            return pointerButton(ev);
        case LIBINPUT_EVENT_POINTER_SCROLL_WHEEL:
        case LIBINPUT_EVENT_POINTER_SCROLL_FINGER:
        case LIBINPUT_EVENT_POINTER_SCROLL_CONTINUOUS:
            return pointerScroll(ev);
