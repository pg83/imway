...
struct Device {
    ...
    virtual Renderer* createRenderer(Scene& scene, Output& output, FrameListener& listener, struct IconStore& icons, const char* fontPath, float uiScale, int framesLimit) = 0;
