...
void Dialog::draw(Composer& c, bool& open) {
    ...
    checkTrue(ImGui::Begin("##history", nullptr, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoDocking));
    if (fresh) {
