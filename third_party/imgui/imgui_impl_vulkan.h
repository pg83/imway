...
IMGUI_IMPL_API void             ImGui_ImplVulkan_SetTextureColor(int source, int primaries, float reference_nits, float min_nits, float max_nits, const float* primaries_to_bt2020, const float* gamma, int alpha_mode, int yuv_coefficients, int yuv_range, int yuv_chroma_location, int yuv_bits);
