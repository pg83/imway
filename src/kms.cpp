...
namespace {
    ...
    struct KmsImpl: public Kms {
            ...
            : server(&srv)
        {
            ...
            sysO << "imway: kms "_sv << path << ": "_sv << mode.hdisplay << "x"_sv << mode.vdisplay << "@"_sv
                 << mode.vrefresh << ", connector "_sv << connectorId << ", crtc "_sv << crtcId
        ...
        void createDumb(DumbBuffer& b) {
            ...
            STD_VERIFY(drmModeAddFB2(fd, mode.hdisplay, mode.vdisplay, DRM_FORMAT_XRGB8888,
