...
int main(void) {
    ...
    // two timestamps within one commit cycle
    wp_commit_timer_v1_set_timestamp(timer, 0, 1, 0);
    wp_commit_timer_v1_set_timestamp(timer, 0, 2, 0);
    return wl_expect_error(wp_commit_timer_v1_interface.name,
