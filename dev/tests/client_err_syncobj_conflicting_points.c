...
int main(void) {
    ...
    wp_linux_drm_syncobj_surface_v1_set_acquire_point(sync_surface, timeline, 0, 2);
    wp_linux_drm_syncobj_surface_v1_set_release_point(sync_surface, timeline, 0, 1);
