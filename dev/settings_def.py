...
SETTINGS = [
    ...
    setting("input.acceleration", "pointerAccelProfile",
            "PointerAccelProfile", "PointerAccelProfile::automatic", "input",
            "acceleration", custom("pageInput")),
    setting("input.tap_to_click", "tapToClick", "bool", "true", "input",
            "tap to click", custom("pageInput")),
    setting("input.natural_scroll", "naturalScroll", "InputToggle",
            "InputToggle::automatic", "input", "natural scroll",
            custom("pageInput")),
    setting("input.left_handed", "leftHanded", "InputToggle",
            "InputToggle::automatic", "input",
            "left handed", custom("pageInput")),
    setting("input.disable_while_typing", "disableWhileTyping", "InputToggle",
            "InputToggle::automatic", "input", "disable while typing",
            custom("pageInput")),
    setting("input.middle_emulation", "middleEmulation", "InputToggle",
            "InputToggle::automatic", "input", "middle emulation",
            custom("pageInput")),
